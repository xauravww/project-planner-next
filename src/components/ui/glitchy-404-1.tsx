...
export function Glitchy404({ width = 860, height = 232, color = "#fff", className }: Glitchy404Props) {
    return (
        <FuzzyWrapper baseIntensity={0.4} className={className ?? "cursor-pointer"}> {/* Use passed className */}
            <div className="relative">
                <svg
                    width={width}
                    height={height}
                    viewBox="0 0 100 29"
                    fill="none" // Changed to none to relying on path fills or parent
                    xmlns="http://www.w3.org/2000/svg"
                    className="cursor-pointer fill-current text-current" // Changed to use current color
